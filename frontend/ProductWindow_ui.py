...
"margin-top: 3px;")
        ...
        self.spinBox_2.setStyleSheet("background-color: rgb(127, 140, 141);\n"
"color: white;")
...
"}")
        ...
        self.horizontalLayout_14.addWidget(self.buy_Button)
...
"border-radius: 15px;")
        ...
        self.spinBox.setStyleSheet("background-color: rgb(127, 140, 141);\n"
"color: white;")
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 946, 346))
