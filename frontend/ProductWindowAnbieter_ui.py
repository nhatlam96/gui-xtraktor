# Form implementation generated from reading ui file 'c:\Users\julia\Documents\HS Worms\Fächer\GUI\hs_wo_gui_2023\frontend\ProductWindowAnbieter.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_10.addWidget(self.lager_status)
        ...
        self.preis_label = QtWidgets.QLabel(parent=self.frame_11)
        self.preis_label.setObjectName("preis_label")
        self.horizontalLayout_15.addWidget(self.preis_label)
        self.preis_status = QtWidgets.QLabel(parent=self.frame_11)
        ...
        self.preis_spinBox = QtWidgets.QSpinBox(parent=self.frame_10)
        self.preis_spinBox.setFrame(False)
        self.preis_spinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.preis_spinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.PlusMinus)
        self.preis_spinBox.setAccelerated(False)
        self.preis_spinBox.setPrefix("")
        self.preis_spinBox.setObjectName("preis_spinBox")
        self.horizontalLayout_14.addWidget(self.preis_spinBox)
        ...
        self.gesamt_label = QtWidgets.QLabel(parent=self.frame_6)
        self.gesamt_label.setObjectName("gesamt_label")
        self.horizontalLayout_6.addWidget(self.gesamt_label)
        self.gesamt_status = QtWidgets.QLabel(parent=self.frame_6)
        self.gesamt_status.setObjectName("gesamt_status")
        self.horizontalLayout_6.addWidget(self.gesamt_status)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1081, 461))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Produkte, Anbieter"))
