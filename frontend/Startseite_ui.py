...
# Form implementation generated from reading ui file 'traktor.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(888, 668)
        self.frame_2 = QtWidgets.QWidget(MainWindow)
        self.frame_2.setObjectName("frame_2")
        self.main_frame = QtWidgets.QFrame(self.frame_2)
        self.main_frame.setGeometry(QtCore.QRect(9, 9, 841, 601))
        ...
        self.content_frame.setGeometry(QtCore.QRect(10, 141, 821, 451))
        ...
        self.frame_4.setGeometry(QtCore.QRect(10, 10, 281, 415))
        ...
        self.katergorie_label = QtWidgets.QLabel(self.frame_15)
        self.katergorie_label.setObjectName("katergorie_label")
        self.horizontalLayout_8.addWidget(self.katergorie_label)
        self.katergorie_lineedit = QtWidgets.QLineEdit(self.frame_15)
        self.katergorie_lineedit.setObjectName("katergorie_lineedit")
        self.horizontalLayout_8.addWidget(self.katergorie_lineedit)
        ...
        self.zustand_lineedit = QtWidgets.QLineEdit(self.frame_14)
        self.zustand_lineedit.setObjectName("zustand_lineedit")
        self.horizontalLayout_9.addWidget(self.zustand_lineedit)
        ...
        self.baujahr_lineEdit = QtWidgets.QLineEdit(self.frame_13)
        self.baujahr_lineEdit.setObjectName("baujahr_lineEdit")
        self.horizontalLayout_10.addWidget(self.baujahr_lineEdit)
        ...
        self.leistung_linedit = QtWidgets.QLineEdit(self.frame_12)
        self.leistung_linedit.setObjectName("leistung_linedit")
        self.horizontalLayout_11.addWidget(self.leistung_linedit)
        ...
        self.km_lineedit = QtWidgets.QLineEdit(self.frame_11)
        self.km_lineedit.setObjectName("km_lineedit")
        self.horizontalLayout_7.addWidget(self.km_lineedit)
        ...
        self.hersteller_lineedit = QtWidgets.QLineEdit(self.frame_10)
        self.hersteller_lineedit.setObjectName("hersteller_lineedit")
        self.horizontalLayout_6.addWidget(self.hersteller_lineedit)
        ...
        self.frame_5.setGeometry(QtCore.QRect(320, 10, 491, 431))
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_5.setObjectName("frame_5")
        self.frame_7 = QtWidgets.QFrame(self.frame_5)
        self.frame_7.setGeometry(QtCore.QRect(10, 10, 451, 44))
        ...
        self.frame_8.setGeometry(QtCore.QRect(10, 70, 451, 341))
        self.frame_8.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_8.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_8.setObjectName("frame_8")
        MainWindow.setCentralWidget(self.frame_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.katergorie_label.setText(_translate("MainWindow", "Katergorie"))
        self.zustand_label.setText(_translate("MainWindow", "Zustand"))
        self.baujahr_label.setText(_translate("MainWindow", "Baujahr"))
        self.leistung_label.setText(_translate("MainWindow", "Leistung"))
        self.km_label.setText(_translate("MainWindow", "Km/h"))
        self.hersteller_label.setText(_translate("MainWindow", "Hersteller"))
        self.typ_label.setText(_translate("MainWindow", "Typ"))
