...
class Ui_Startseite(object):
    def setupUi(self, Startseite):
        ...
        self.content_frame.setGeometry(QtCore.QRect(10, 131, 821, 641))
        ...
        self.frame_4.setGeometry(QtCore.QRect(10, 10, 241, 591))
        ...
        self.horizontalSlider_preis.setMaximum(2000000)
        self.horizontalSlider_preis.setSingleStep(100)
        ...
        self.verticalLayout_3.addWidget(self.horizontalSlider_preis)
        self.preis_anzeigt = QtWidgets.QLabel(self.frame_15)
        self.preis_anzeigt.setText("")
        self.preis_anzeigt.setAlignment(QtCore.Qt.AlignCenter)
        self.preis_anzeigt.setObjectName("preis_anzeigt")
        self.verticalLayout_3.addWidget(self.preis_anzeigt)
        ...
        self.frame_5.setGeometry(QtCore.QRect(270, 20, 511, 581))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 472, 509))
